 ...
 */
export function normalizeFilePaths(filePath, filePaths) {
    const allPaths = [];
    if (filePath) {
 ...
 */
export function readFilesForAnalysis(paths, fileSystem = fs) {
    const fileContents = [];
 ...
 */
export function buildCodeSection(fileContents, code, language) {
    let codeSection = '';
 ...
 */
export function buildAnalysisTarget(fileCount, language) {
 ...
 */
export function getFocusInstructions(focus) {
    switch (focus) {
        case 'quality':
 ...
 */
export function buildAnalysisPrompt(fileContents, code, language, focus = 'general') {
