...
export const proModel = () => process.env.GEMINI_PRO_MODEL || DEFAULT_PRO_MODEL;
export const flashModel = () => process.env.GEMINI_FLASH_MODEL || DEFAULT_FLASH_MODEL;
export const imageModel = () => process.env.GEMINI_IMAGE_MODEL || DEFAULT_IMAGE_MODEL;
export const videoModel = () => process.env.GEMINI_VIDEO_MODEL || DEFAULT_VIDEO_MODEL;
