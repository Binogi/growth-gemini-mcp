...
export function registerDeepResearchTool(server: McpServer): void {
  ...
  server.tool(
    ...
    'Start an autonomous Gemini Deep Research task (5-60 minutes, runs on Google servers). Returns a research ID. ' +
...
Check again in 30-60 seconds using \`gemini-check-research\`.`,
  ...
  server.tool(
    ...
    'Ask a follow-up question about a completed Deep Research task; the answer is generated by the configured pro ' +
